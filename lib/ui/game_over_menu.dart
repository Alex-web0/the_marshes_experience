    ...
    return Center(
      child: LiquidGlassContainer(
        ...
        child: Column(
          ...
          children: [
            Text("GAME OVER", style: kDisplayFont.copyWith(fontSize: 40, color: Colors.white)),
            ...
            Text(
              ...
              style: kGameFont.copyWith(
                fontSize: 18, 
                color: _isNewHighScore ? Colors.amberAccent : Colors.white70
              ),
            ),
            ...
            Row(
              ...
              children: [
                _StatItem(icon: Icons.set_meal, value: "${widget.stats.fishCount}", label: "Fish"),
                _StatItem(icon: Icons.map, value: "${widget.stats.score}m", label: "Dist"),
                _StatItem(icon: Icons.import_contacts, value: "${widget.stats.storyCount}", label: "Stories"),
              ],
            ),
            ...
            // Actions
            _GlassButton(label: "PLAY AGAIN", onTap: widget.onPlayAgain), 
    ...
    return Container(
      ...
      child: Column(
        children: [
          ...
          Text(value, style: kGameFont.copyWith(fontSize: 20, color: Colors.white)),
          Text(label, style: kGameFont.copyWith(fontSize: 12, color: Colors.white54)),
        ],
      ),
    );
  }
...
class _RankDisplay extends StatelessWidget {
    ...
    Widget build(BuildContext context) {
        return Text(
           "Rank: ${getRank()}",
           style: kGameFont.copyWith(color: Colors.amber, fontSize: 16, letterSpacing: 1.2),
        );
    }
}
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          color: Colors.black.withOpacity(0.7), // Matched to new black button style
